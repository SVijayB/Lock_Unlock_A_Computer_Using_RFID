...
Please note we have a [code of conduct](https://github.com/SVijayB/Lock_Unlock_A_Computer_Using_RFID/blob/master/docs/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
